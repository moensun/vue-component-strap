...
/***/ function(module, exports, __webpack_require__) {
	...
	vueRouter.map(_router2.default);
	
	document.addEventListener('DOMContentLoaded', function () {
	  vueRouter.start(_app2.default, '#app');
	}, false);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = Vue;
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }()), __webpack_require__(11), __webpack_require__(12)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] example/component/main.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Users/fengxiaotx/Develop/workspace/nodejs/npm/vue-component-strap/example/component/main.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _treeCombox = __webpack_require__(26);
	
	var _treeCombox2 = _interopRequireDefault(_treeCombox);
	
	var _dateField = __webpack_require__(55);
	...
	module.exports = {
		...
		msDatepickerRangeSingle: _datepickerRangeSingle2.default,
		treeCombox: _treeCombox2.default,
		msDateField: _dateField2.default,
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/form/field/tree-combox.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _treeView2 = __webpack_require__(31);
	    ...
	    watch: {
	        'data': {
	            handler: function handler(newValue, oldVal) {
	                if (newValue) {
	                    var _treeView = this.$refs.treeView;
	                    _treeView.initData();
	                }
	            }
	        },
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/tree/tree-view.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TreeViewMixin = __webpack_require__(35);
	
	var _TreeViewMixin2 = _interopRequireDefault(_TreeViewMixin);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	exports.default = {
	    name: 'treeView',
	    mixins: [_TreeViewMixin2.default],
	    props: {},
	    data: function data() {
	        return {
	            tempData: []
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        formatData: function formatData(items, level, parent) {
	            var me = this;
	            var spaceHtml = "";
	            ...
	            if (items && items.length > 0) {
	                _.each(items, function (item, index) {
	                    if (level === 1) {
	                        (0, _assign2.default)(item, { "level": level, "spaceHtml": spaceHtml, "isShow": true });
	                        if (!item.expanded) {
	                            (0, _assign2.default)(item, { "expanded": false });
	                        }
	                        item = (0, _assign2.default)({}, item);
	                    }
	
	                    me.tempTreeData.push(item);
	                    var currentIndex = me.tempTreeData.length - 1;
	                    if (level != 1) {
	                        _vue2.default.set(me.tempTreeData[currentIndex], 'parent', parent);
	                        _vue2.default.set(me.tempTreeData[currentIndex], 'level', level);
	                        _vue2.default.set(me.tempTreeData[currentIndex], 'spaceHtml', spaceHtml);
	                        if (!me.tempTreeData[currentIndex].expanded) {
	                            _vue2.default.set(me.tempTreeData[currentIndex], 'expanded', false);
	                            _vue2.default.set(me.tempTreeData[currentIndex], 'isShow', false);
	                        } else {
	                            _vue2.default.set(me.tempTreeData[currentIndex], 'isShow', true);
	                        }
	                    }
	        ...
	        open: function open(index, record) {
	            var me = this;
	        ...
	        close: function close(index, record) {
	            var me = this;
	            if (record.children) {
	        ...
	        showUpLevel: function showUpLevel(record) {
	            var me = this;
	            if (record.parent) {
	                record.parent.expanded = true;
	                var children = record.parent.children;
	                if (children) {
	        ...
	        selectValue: function selectValue(index, record) {
	            var me = this;
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        "getDaysInMonth": function getDaysInMonth(year, month) {
	            var me = this;
	            return month === 1 && year % 4 === 0 && (year % 100 !== 0 || year % 400 === 0) ? 29 : me.DAYS_IN_MONTH[month];
	        },
	        "getDates": function getDates(startDate, n) {
	...
	exports.default = {
	    ...
	    data: function data() {
	        return {
	            ...
	            "endDayObj": null,
	            "selectedDatesObj": [],
	            "showMonths": [new Date(), new Date(new Date().getFullYear(), new Date().getMonth() + 1)]
	        };
	    },
	    ready: function ready() {
	        var me = this;
	        if (me.startDay) {
	            var month1 = new Date(me.dateAdapter(me.startDay));
	            var month2 = _.cloneDeep(month1);
	    ...
	    computed: {
	        "monthsRange": function monthsRange() {},
	    ...
	    methods: {
	        ...
	        "previous": function previous() {
	            var me = this;
	            var month1 = new Date(me.showMonths[0]);
	            month1.setMonth(month1.getMonth() - 1);
	            var month2 = new Date(me.showMonths[1]);
	            month2.setMonth(month2.getMonth() - 1);
	            me.showMonths = [month1, month2];
	        },
	        "next": function next() {
	    ...
	    components: {
	        datepickerRange: _datepickerRange2.default
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    methods: {
	        "selectCurrentMonth": function selectCurrentMonth() {
	            var me = this;
	            var startDay = new Date(me.currentDate.getFullYear(), me.currentDate.getMonth(), 1);
	            var monthDayCount = me.getDaysInMonth(me.currentDate.getFullYear(), me.currentDate.getMonth());
	            var endDay = new Date(me.currentDate.getFullYear(), me.currentDate.getMonth(), 1);
	        ...
	        "setSelectedDates": function setSelectedDates() {
	            ...
	            if ((0, _typeof3.default)(me.endDay) != 'object') {
	                me.endDay = new Date(me.endDay);
	            }
	            if (me.startDay && me.endDay) {
	                var dates = [];
	                var startDay = new Date(me.startDay.getFullYear(), me.startDay.getMonth(), me.startDay.getDate());
	    ...
	    components: {
	        datepickerRangeDay: _datepickerRangeDay2.default
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        "cancelDay": function cancelDay() {
	            var me = this;
	            var dates = _.cloneDeep(me.selectedDates);
	            var index = -1;
	            _.forEach(dates, function (date, itemIndex) {
	                if (me.dayItem.getFullYear() == date.getFullYear() && me.dayItem.getMonth() == date.getMonth() && me.dayItem.getDate() == date.getDate()) {
	                    index = itemIndex;
	                }
	            });
	            if (index >= 0) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    components: {
	        datepickerRangeDayPanel: _datepickerRangeDayPanel2.default,
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        "previousMouth": function previousMouth() {
	            var me = this;
	            var date = _lodash2.default.cloneDeep(me.currentDate);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    components: {
	        datepickerYear: _datepickerYear2.default
	    }
	};
	...
	exports.default = {
	    ...
	    computed: {
	        "isCurrentYear": function isCurrentYear() {
	            var me = this;
	            return me.currentYear == me.yearItem;
	        }
	    },
	    methods: {
